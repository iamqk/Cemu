...
extern void __start_context1(void);


void
__makecontext1(ucontext_t *ucp, void (*func)(void), int argc, ...)
{
	unsigned long *sp;
	unsigned long *regp;
	va_list va;
	...
	ucp->uc_mcontext.regs[30] = (uintptr_t) &__start_context1;
...
extern __typeof(__makecontext1) makecontext1; \
    __asm__(".globl _makecontext1"); \
    __asm__(".set _makecontext1, ___makecontext1");
